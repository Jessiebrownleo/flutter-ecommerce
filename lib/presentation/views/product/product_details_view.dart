            ...
            SizedBox(
              ...
              child: InputFormButton(
                onClick: () {
                  ...
                  print('🛒 [DEBUG] Product: ${widget.product.name}');
                  print('🛒 [DEBUG] Price Tag: ${_selectedPriceTag.name} - \$${_selectedPriceTag.price}');
                  
                  final cartItem = CartItem(
                      product: widget.product,
                      priceTag: _selectedPriceTag);
                  
                  print('🛒 [DEBUG] Dispatching AddProduct event to CartBloc');
                  context.read<CartBloc>().add(AddProduct(cartItem: cartItem));
                  
                  print('🛒 [DEBUG] Closing product details page');
