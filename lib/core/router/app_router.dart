...
import '../../presentation/views/payment/payment_qr_view.dart';
...
class AppRouter {
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case paymentQR:
        OrderDetails orderDetails = routeSettings.arguments as OrderDetails;
        return MaterialPageRoute(
            builder: (_) => PaymentQRView(orderDetails: orderDetails));
      default:
